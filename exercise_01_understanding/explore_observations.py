...
for agent in env.agent_iter():
    ...
    print("Grille de l'agent courant\n", observation['observation'][:,:,0]) #player_0
    print("Grille de l'adversaire\n", observation['observation'][:,:,1]) #player_1

    # TODO: Take a random action (column 3)
    env.step(3)
    observation, reward, termination, truncation, info = env.last()
    print("Grille de l'agent courant\n", observation['observation'][:,:,0]) #player_1
    print("Grille de l'adversaire\n", observation['observation'][:,:,1]) #player_0
